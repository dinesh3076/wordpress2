								...
								<span class="resume-settings-bttn">
									...
									<?php if(get_post_status($comp_id) != 'pending') { ?>
								    	...
								    	<form id="postStatusForm<?php echo $comp_id; ?>" type="post" action="" >
									   	...
									   	<form id="featForm<?php echo $comp_id; ?>" method="post" action="<?php echo get_template_directory_uri(); ?>/paypal/form-handler-regular.php?func=addrow">

									    	<?php global $redux_demo; $comp_valid = $redux_demo['resume-regular-validity']; $comp_price = $redux_demo['resume-regular-price']; $price_symbol = $redux_demo['job-price-symbol']; $dec = sprintf('%.2f', $comp_price / 100);  ?>
							    ...
							    <span class="my-account-company-single">
							    	...
							    	<?php if(get_post_status($result_company[$key]) != 'pending') { ?>
								    	...
								    	<form id="postStatusForm<?php echo $result_company[$key]; ?>" type="post" action="" >
									   	...
									   	<form id="featForm<?php echo $result_company[$key]; ?>" method="post" action="<?php echo get_template_directory_uri(); ?>/paypal/form-handler-regular.php?func=addrow">

									    	<?php global $redux_demo; $comp_valid = $redux_demo['company-regular-validity']; $comp_price = $redux_demo['company-regular-price']; $price_symbol = $redux_demo['job-price-symbol']; $dec = sprintf('%.2f', $comp_price / 100);  ?>

											<input type="hidden" name="AMT" value="<?php echo $dec; ?>" />
											<input type="hidden" name="plan_price" value="<?php echo $dec; ?>">
											<input type="hidden" name="PAYMENTREQUEST_0_DESC" value="<?php echo $result_company[$key]; ?>" />
											<?php global $redux_demo; $currency_code = $redux_demo['currency_code']; ?>
											<input type="hidden" name="CURRENCYCODE" value="<?php echo $currency_code; ?>">
											...
											<input type="hidden" name="plan_name" value="<?php echo $result_company[$key]; ?>">
									    ...
									    <script type="text/javascript">
											...
											jQuery(function($) {
												...
												jQuery('#publish-payed-<?php echo $result_company[$key]; ?>').click(function(e) {

		  											e.preventDefault();  // don't submit it
												    jQuery("#featForm<?php echo $result_company[$key]; ?>").trigger('submit')
							    	...
							    	<?php if(get_post_status($result_company[$key]) != 'pending') { ?>
								    	...
								    	<span class="my-account-job-single-feature">
											...
											<?php 
									    		...
									    		<form id="featForm<?php echo $result_company[$key]; ?>" method="post" action="<?php echo get_template_directory_uri(); ?>/paypal/form-handler.php?func=addrow">
									    		...
									    		jQuery('#make-featured-<?php echo $result_company[$key]; ?>').click(function(e) {
							    ...
							    <span class="my-account-job-single">
							    	...
							    	<?php if(get_post_status($result_job[$key]) != 'pending') { ?>
								    	...
								    	<form id="postStatusForm<?php echo $result_job[$key]; ?>" type="post" action="" >
									   	...
									   	<form id="featForm<?php echo $result_job[$key]; ?>" method="post" action="<?php echo get_template_directory_uri(); ?>/paypal/form-handler-regular.php?func=addrow">

									    	<?php global $redux_demo; $comp_valid = $redux_demo['job-regular-validity']; $comp_price = $redux_demo['job-regular-price']; $price_symbol = $redux_demo['job-price-symbol']; $dec = sprintf('%.2f', $comp_price / 100);  ?>

											<input type="hidden" name="AMT" value="<?php echo $dec; ?>" />
											<input type="hidden" name="plan_price" value="<?php echo $dec; ?>">
											<input type="hidden" name="PAYMENTREQUEST_0_DESC" value="<?php echo $result_job[$key]; ?>" />
											<?php global $redux_demo; $currency_code = $redux_demo['currency_code']; ?>
											<input type="hidden" name="CURRENCYCODE" value="<?php echo $currency_code; ?>">
											...
											<input type="hidden" name="plan_name" value="<?php echo $result_job[$key]; ?>">
									    ...
									    <script type="text/javascript">
											...
											jQuery(function($) {
												...
												jQuery('#publish-payed-<?php echo $result_job[$key]; ?>').click(function(e) {

		  											e.preventDefault();  // don't submit it
												    jQuery("#featForm<?php echo $result_job[$key]; ?>").trigger('submit')
							    	...
							    	<?php if(get_post_status($result_job[$key]) != 'pending') { ?>
								    	...
								    	<span class="my-account-job-single-feature">
											...
											<?php 
									    		...
									    		<form id="featForm<?php echo $result_job[$key]; ?>" method="post" action="<?php echo get_template_directory_uri(); ?>/paypal/form-handler.php?func=addrow">
									    		...
									    		jQuery('#make-featured-<?php echo $result_job[$key]; ?>').click(function(e) {
